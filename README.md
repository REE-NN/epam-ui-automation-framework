...
Проект был выполнен как внутренний инженерный фреймворк для автоматизации сценариев Яндекс.Почты — для поддержки команд EPAM, реализующих интеграционные решения с сервисами Яндекса.
